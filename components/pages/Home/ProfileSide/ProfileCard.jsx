  ...
  return (
    <>
      <div className="w-full p-5 bg-gray-100 rounded-lg drop-shadow-lg ">
        ...
        <button class="transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 bgBtn px-4 py-2 rounded-md w-80 ml-8 font-bold text-white">
          My Profile
        </button>
      </div>
    </>
